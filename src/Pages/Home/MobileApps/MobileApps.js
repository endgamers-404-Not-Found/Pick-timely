...
function MobileApps() {
    return (
        <div className='mt-10  pl-4 lg:h-[500px]  lg:flex lg:text-left text-center justify-evenly lg:pt-32'>
            <div className=' lg:w-4/12 mx-10 sm:pt-5 lg:pt-16 text-center lg:text-left'>
