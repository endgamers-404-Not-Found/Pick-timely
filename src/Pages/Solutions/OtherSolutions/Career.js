...
const Career = () => {
    ...
    useEffect(() => {
        fetch('https://pick-timely-server.onrender.com/easySchedule')
            .then(res => res.json())
            .then(data => {
    ...
    return (
        <div className='flex justify-center items-center lg:p-20 p-8'>
            <div className="w-full">
                <div className='w-[100%] lg:w-[50%] mx-auto'>
                    <h1 className=" text-4xl md:text-5xl font-bold mt-10 text-center ">A great scheduler should fulfill your customers' expectations</h1>
