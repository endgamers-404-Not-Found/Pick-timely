...
const Recruitment = () => {
    ...
    return (
        <div>
            <div className="hero  lg:p-20 p-8">
                <div className="hero-content text-center">
                    <div className="w-full">
                        <div className='w-[100%] lg:w-[50%] mx-auto'>
                            <h1 className=" text-4xl md:text-5xl  font-bold mb-10 text-center ">A good scheduler gives you more than the basics without compromising the essentials</h1>
                        </div>
