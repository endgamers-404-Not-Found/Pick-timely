...
const Podcasts = () => {
    ...
    return (
            ...
            <div class="hero bg-slate-300 p-20">
                <div class="hero-content text-center">
                    <div class="w-full">
                    <div className='w-[100%] lg:w-[70%] mx-auto'>
                        <h1 class="lg:text-5xl text-2xl font-bold mb-10">Everything you need to successfully coordinate interviews</h1>
                        </div>
                        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 place-items-center'>
                            {
                                recruitments.map(recruitment => <div class="card w-96 bg-base-100 shadow-xl">
                                <div class="card-body">
