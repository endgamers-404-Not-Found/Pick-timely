    ...
    return (
        <div className='w-[100%] mx-auto px-10'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 justify-items-center'>
                ...
                <div key={team._id} className="card lg:w-96 w-80 bg-gray-100  border-gray-300 border-2">
                    <figure>
                    ...
                    <div class="card-body">
                        ...
                        <div className='grid grid-cols-5 gap-10 pr-6'>
                            <p className='font-semibold'>
                                <a href={team.portfolio} rel="noreferrer" target="_blank" >
                                    <img className='w-20' src="https://i.ibb.co/NSY0X1T/image.png" alt="portfolio" /> <span className='font-semibold text-center text-xs hover:link hover:text-blue-600'>Portfolio</span>
                                </a>
                            </p>
                            <p className='font-semibold'>
                                <a href={team.resume} rel="noreferrer" target="_blank">
                                    <img className='w-20' src="https://i.ibb.co/QrZjTRD/image.png" alt="portfolio" /> 
                            ...
                            <p className='font-semibold'>
                                <a href={team.github} rel="noreferrer" target="_blank" >
                                    <img className='w-20' src="https://i.ibb.co/thGGwxh/image.png" alt="portfolio" /> 
                            ...
                            <p className='font-semibold'>
                                <a href={team.linkedIn} rel="noreferrer" target="_blank"  >
                                    <img className='w-20' src="https://i.ibb.co/LYfZwHv/download.png" alt="portfolio" />
                            ...
                            <p className='font-semibold'>
                                <a href={team.facebook} rel="noreferrer" target="_blank" >
                                    <img className='w-20' src="https://i.ibb.co/DWjbLbH/2021-Facebook-icon-svg.png" alt="portfolio" /> 
