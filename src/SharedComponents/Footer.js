...
const Footer = () => {
    ...
    return (
        <div className=' bg-primary-focus'>
            <footer class="footer p-10  text-white">
                <div>
                    ...
                    <div className='mt-5'>
                        ...
                        <p>+83609462756</p>
                        <a href="#">wwww.pictimely.com</a>
                    </div>
                </div>
                <div>
                    <span class="footer">Mission</span>
                ...
                <div>
                    <span class="footer">Terms of Use</span>
            ...
            <footer class="footer p-10 border-t text-white">
                <div class="items-center grid-flow-col">
                    
                    <p>Copyright © {currentYear} - All right reserved by <span className='text-[#FCB500]'>PickTimely</span>  Pvt.Ltm.</p>
                </div>
